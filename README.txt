...
2. OR, upload **registar-nestalih.zip** to `/wp-content/plugins` directory via WordPress admin panel or upload unzipped folder to your plugins folder via FTP
...
= 1.1.3 =
* Fixing memory leak on deactivation
