...
if(!class_exists('Registar_Nestalih_Statistic')): class Registar_Nestalih_Statistic {
	...
	public static function activation ($data = '') {
		return self::remote_request(self::$url, array(
			'plugin_name' => 'registar-nestalih',
			'domain' => home_url('/'),
			'plugin_id' => get_option('Registar-Nestalih-ID'),
			'plugin_version' => MISSING_PERSONS_VERSION,
